...
const GUIDE_CACHE   = 'mufasa-guide-v3';

/* ── Base path (GitHub Pages subfolder) ── */
const BASE = '/M';
...
const PRECACHE_URLS = [
  BASE + '/',
  BASE + '/index.html',
  BASE + '/mufasa-guide.html',
  BASE + '/manifest.json',

  /* ── Core images ── */
  BASE + '/mufasa-header-logo.png',
  BASE + '/hero-bg.png',
  BASE + '/343490bc1f30e07fafa24787db7cc40e.jpg',
  BASE + '/b580ce7684acdf3f50585a63262be7b6.jpg',
  BASE + '/FB_IMG_17764489238779449.jpg',
